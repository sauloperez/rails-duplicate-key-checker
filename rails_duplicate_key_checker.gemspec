...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Generates Rails migrations for each of your duplicated database table indexes}
  spec.description   = %q{Generates Rails migrations for each of your duplicated database table indexes}
